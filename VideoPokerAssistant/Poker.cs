...
namespace VideoPokerAssistant
{
    public class Poker
    {
        ...
        public void BestHand()
        {
            ...
            for (byte replacedCards = 0; replacedCards < replaceCombinations; replacedCards++)
            {
                ...
                */
                ...
                expectedReturnValues[replacedCards] = BruteForce(handCopy, deckCopyArray, replacedCards);
        ...
        public double BruteForce(List<int> handCopy, int[] deckCopy, int forLoopNumber)
        {
